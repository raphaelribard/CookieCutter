# -*- coding: utf-8 -*-
#
# Trial documentation build configuration file, created by
# sphinx-quickstart.
#
...
man_pages = [
    ('index', 'trial', u'Trial Documentation',
...
texinfo_documents = [
    ('index', 'trial', u'Trial Documentation',
     u"Your name (or your organization/company/team)", 'Trial',
